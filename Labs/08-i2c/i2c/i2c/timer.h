...
#define TIM0_overflow_4096u()    TCCR0B &= ~((1<<CS01) | (1<<CS00)); TCCR0B |= (1<<CS02);
...
/** @brief Set overflow 1024u, prescaler 011 --> 64 */
#define TIM2_overflow_1024u() TCCR2B &= ~(1<<CS22); TCCR2B |= (1<<CS21) | (1<<CS20);
/** @brief Set overflow 4096u, prescaler 100 --> 256 */
#define TIM2_overflow_4096u()    TCCR2B &= ~((1<<CS21) | (1<<CS20)); TCCR2B |= (1<<CS22);
/** @brief Set overflow 16384u, prescaler // 101 --> 1024 */
#define TIM2_overflow_16384u()    TCCR2B &= ~(1<<CS21); TCCR2B |= (1<<CS22) | (1<<CS20);
/** @brief Enable overflow interrupt, 1 --> enable */
